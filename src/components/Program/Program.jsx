...
const AccordionItem = ({ phase, isOpen, onToggle }) => {
  ...
  return (
    ...
    >
      <button className="curriculum-detailed__header" onClick={onToggle}>
        <span className="curriculum-detailed__modnum">{phase.number}</span>
        <span className="curriculum-detailed__modtitle">{phase.title}</span>
        <img
      ...
      >
        {/* Everything to be revealed goes here */}
        <div ref={innerRef} className="curriculum-detailed__inner">
          <ul className="curriculum-detailed__list">
