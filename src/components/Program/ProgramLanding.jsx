    ...
    <section className="program-landing">
      ...
      <div className="program-landing__top">
        ...
        <div className="program-landing__intro">
          <p>
            ...
            hands-on, outcomes-driven journey that takes you from spark to
            scale. Master the startup lifecycle through expert-designed modules,
      ...
      <div className="program-landing__cta">
        ...
        <div className="program-landing__cta-content">
          ...
          <button
            className="program-landing__cta-button"
            type="button"
