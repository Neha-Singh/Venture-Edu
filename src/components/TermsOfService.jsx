      ...
      <div className="tou-modal-content" onClick={handleContentClick}>
        ...
        <div className="tou-modal-body">
          ...
          <p>
            ...
            thereof (the “Site Content”) is the exclusive property of Virahanka
            Learning Private Limited. Neither the Site Content nor functionality
            of the Site, may be copied, reproduced, modified, reverse
            engineered, altered (including the removal or disabling of any
            security or technological safeguards, disclaimers, or legends)
            uploaded, published, posted, transmitted, or distributed in any way
            without our written permission, except for those uses specified in
            the following paragraph.
          </p>
          <p>
            Virahanka Learning Private Limited hereby grants you a limited,
            ...
            transmit, post, or disclose the Site Content without Virahanka
            Learning Private Limited’s prior written consent. The license
            granted herein terminates automatically and immediately if you do
            not comply with all the terms.
          </p>
          <p>
            ...
            is provided with the understanding that Virahanka Learning Private
            Limited is not herein engaged in rendering professional advice or
            services to you, no Site content is intended to serve as or shall be
            deemed investment, legal, tax, accounting or other regulated advice,
            and that you shall remain solely responsible for your use of all
            Site content and acknowledge that any reliance upon the Site content
          ...
          <p>
            ...
            fitness for a particular purpose. Virahanka Learning Private Limited
            makes no warranties, express or implied, as to the ownership,
            accuracy, or adequacy of the Site content. Virahanka Learning
            Private Limited shall have no liability or responsibility for any
            information published on linked websites, contained in any user
            submissions published on the Site, or provided by third parties.
          </p>
          <p>
            Virahanka Learning Private Limited shall not be liable for any
          ...
          <p>
            Virahanka Learning Private Limited does not represent or endorse the
            accuracy or reliability of information posted to the Site by users.
            In addition, we do not and cannot review all information posted to
            the Site by users and are not responsible for such information.
            However, Virahanka Learning Private Limited reserves the right to
            refuse to post and the right to remove any information, in whole or
            in part, for any reason or for no reason.
          </p>
          <p>
            Virahanka Learning Private Limited might often refer to reports,
            data, industry insights (“External Information”) by other
            organizations with clear attribution under the fair use policy.
            Virahanka Learning Private Limited is not responsible for the
            accuracy, adequacy or completeness of the afore-mentioned External
            Information. Virahanka Learning Private Limited prohibits the
            posting of any information that infringes or violates the copyright
            rights and/or other intellectual property rights of any person or
            entity. If you believe that your intellectual property right (or
            such a right that you are responsible for enforcing) is infringed by
            any content on the Site, please write to Virahanka Learning Private
            Limited at info@venturedu.com, clearly highlighting the content on
            the Site which is in supposed violation, the details of the
            copyrighted material said to be infringed and contact details of the
            owner of the said material.
          </p>
          <p>
